"""Train or dry-run the Magenta Music Transformer benchmark alias."""
...
def parse_args() -> argparse.Namespace:
    spec = get_benchmark_model_spec("magenta_music_transformer")
...
def main() -> None:
    ...
    validate_benchmark_model_config(config, expected_model="magenta_music_transformer")
